 ...
 * 事务AOP配置
 *
 * Created by hh on 2018/5/23.
 */
@Aspect
@Configuration
public class TxTransactionInterceptor {
    private static final int TX_METHOD_TIMEOUT = 1800;
    ...
    /*当前存在事务就使用当前事务，当前不存在事务就创建一个新的事务*/
        ...
        requiredNew.setTimeout(TX_METHOD_TIMEOUT);

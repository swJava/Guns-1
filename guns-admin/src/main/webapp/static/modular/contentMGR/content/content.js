...
Content.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '类型： 1 普通文章   2 外链文章  3 外链视频', field: 'typeName', visible: true, align: 'center', valign: 'middle'},
            ...
            {title: '发布类型： 1=引用   2=原创', field: 'publishTypeName', visible: true, align: 'center', valign: 'middle'},
            ...
            {title: '状态: 1=启用，2=禁用', field: 'statusName', visible: true, align: 'center', valign: 'middle'}
    ];
};
